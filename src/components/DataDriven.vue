...
<div class="flex justify-center p-4">
    <div class="w-[80%]">
        <div class="text-gray-700 text-4xl font-bold opacity-0 slidet my-4">Proactive search by Syncona team for appropriate assets</div>
        <div class="text-gray-700 text-4xl font-bold opacity-0 slidet my-4">Ideal characteristics of a scientific asset</div>
        <div class=" opacity-0 slidet"><img :src="img1" class="h-[400px]"></div>
        <div class=" opacity-0 slidet">
        <div class="text-gray-700 my-4 text-3xl font-bold">Key decision-making factors</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Intellectual property</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Globally leading academics</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Technology</div>
       </div>
        <div  class=" opacity-0 slidet">
               <div class="text-gray-700 my-4 text-3xl font-bold">Key decision-making factors</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Assess probability of success for the product’s approval, taking account of benchmarks if relevant or appropriate</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Write business plan and develop plan to build out team and operational capability</div>
 </div>
 <div class=" opacity-0 slidet">
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>For each new investment, the Syncona Investment Committee assesses capital invested across the portfolio to ensure it is diversified and well-balanced</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Assess the long-term capital requirements and key risks and value inflection points</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>For each new investment, the Syncona Investment Committee assesses capital invested across the portfolio to ensure it is diversified and well-balanced</div>
              <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Assess the long-term capital requirements and key risks and value inflection points</div>
       </div>
        <div class=" opacity-0 slidet">
               <div class="text-gray-700 my-4 text-3xl font-bold">Key decision-making factors</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Ongoing evaluation of emerging data and analysis of evolving competitive landscape</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Globally leading academics</div>
       <div class="text-xl my-4"> <span class="text-yellow-500">&mdash;</span>Undertakes rigorous returns analysis</div>
       </div>
</div>
</div>
