<template>
  <div class="w-full h-full">
        ...
        <div class="w-[50%] h-full flex justify-center sm:justify-start items-center"><div class="ph:text-xl xl:text-5xl sm:text-3xl">Contact</div></div>
...
<!--PageContent-->
    <div class="w-full flex flex-col">
          ...
          <div class="w-full h-[400px] p-4 bg-gray-200 flex flex-row ph:flex-wrap sm:flex-wrap">
        <div class="ph:text-xl sm:text-4xl ph:w-full sm:w-full xl:w-[50%] opacity-0 slidet p-4 text-gray-600">Getting in touch with us</div>
        <div class="ph:w-full sm:w-full xl:w-[50%] opacity-0 slidet text-xl text-gray-600 p-4">Find contact details below tailored to the nature of your enquiry.y</div>
</div>
...
<div class="p-4 w-full">
  ...
  <div class="flex flex-row ph:flex-wrap sm:flex-wrap justify-between p-4 h-[90%]">
   <div class="flex justify-center xl:w-[50%] ph:w-full sm:w-full opacity-0 slidet ph:border-t sm:border-t xl:border-t-0 border-gray-300 text-white xl:text-5xl ph:text-xl sm:text-2xl items-center"><div><a class="hover:text-white hover:underline duration-500">About Us</a></div></div>
   <div class="flex justify-center xl:w-[50%] ph:w-full sm:w-full opacity-0 slidet ph:border-t sm:border-t xl:border-t-0 xl:border-l border-gray-300 text-white xl:text-5xl ph:text-xl sm:text-2xl items-center duration-500"><div><a class="hover:text-white hover:underline duration-500">Investor</a></div></div>
  </div>
</div>
