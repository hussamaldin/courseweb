...
<div class="py-[50px] h-[650px]  flex justify-center my-[45px]">
  <div class="flex flex-row my-4 h-[95%] justify-center w-[90%] items-center">
    ...
    <div class="w-full  text-gray-100 p-4 bg-gray-700 my-4">
        <div class="flex justify-center text-white opacity-0 slidet text-2xl"><div>OUR BUSINESS IN NUMBERS*</div></div>
        <div class="flex flex-col justify-center p-4">
          <div class="flex flex-row justify-center opacity-0 slidet my-4 p-4">
            <div class=" w-[30%] mx-2 flex flex-col">
              <div class="text-5xl text-gray-300 border-b-2 border-white p-4">11</div>
              <div class="text-xl p-4">portfolio companies</div>
            </div>
            <div class="w-[30%] mx-2 flex flex-col">
              <div class="text-5xl text-gray-300 border-b-2 border-white p-4">£843m</div>
              <div class="text-xl p-4">value of life science portfolio</div>
            </div>
              <div class=" w-[30%] mx-2 flex flex-col">
              <div class="text-5xl text-gray-300 border-b-2 border-white p-4">£497m</div>
              <div class="text-xl p-4">capital pool</div>
            </div>
            
          </div>
          <div class="flex flex-row justify-center opacity-0 slidet my-4 p-4">
            <div class=" w-[30%] mx-2 flex flex-col">
              <div class="text-5xl border-b-2 border-white p-4">14</div>
              <div class="text-xl p-4">members of the investment team</div>
            </div>
            <div class="w-[30%] mx-2 flex flex-col">
              <div class="text-5xl border-b-2 border-white p-4">79%</div>
              <div class="text-xl p-4">investment team with PhDs/MDs</div>
            </div>
              <div class=" w-[30%] mx-2 flex flex-col">
              <div class="text-5xl border-b-2 border-white p-4">16</div>
              <div class="text-xl p-4">portfolio company board seats</div>
            </div>
