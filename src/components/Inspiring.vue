<template>
  <div class="w-full">
        ...
        <div class="w-[60%] h-full flex justify-center items-center"><div class="xl:text-4xl sm:text-2xl ph:text-xl">Inspiring and empowering our people</div></div>
...
We actively encourage our employees to participate in our partnership schemes, either as advocates, mentors or buddies, with our D&I strategy also aligned with the goals of the</p>
       </div>
    </div>
